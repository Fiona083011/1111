...
public class Q3Magnets {
   ...
   * - A letter describing the piece color ('W', 'B', 'O', 'P').
   * - Two digits forming an integer for the piece location ('00' - '15')
   ...
   * - Be comprised of exactly sixteen well-formed piece placements
   * - Have exactly four pieces of each kind
